...
describe("CustomSerialise integration", () => {
    ...
    it("throws when serializer returns invalid runtime type", () => {
        ...
        class Test {
            ...
            @Field(TSType.Value)
            @CustomSerialise<number, number>(
                () => "invalid" as any,   // bypass compile-time typing
                v => v,
                "number"
            )
            value!: number;
    ...
    it("skips null values in custom serialisation", () => {
...
describe("CustomSerialise - handlesNull behaviour", () => {
    ...
    it("round-trips null when serializer handles null", () => {
    ...
    it("undefined values are normalised to null when serializer does not handle null", () => {
